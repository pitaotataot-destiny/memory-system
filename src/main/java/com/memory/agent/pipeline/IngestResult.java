...
public record IngestResult(
    ...
    /** 创建成功结果 */
    public static IngestResult success(String typeKind, double confidence, String memoryId,
                                        Map<String, Object> fields, Set<String> tags) {
        return new IngestResult(typeKind, confidence, memoryId, fields, tags,
            IngestDecision.STORE, Instant.now(), null);
    }

    /** 创建失败结果 */
    public static IngestResult failed(String error) {
        return new IngestResult(null, 0, null, null, null,
